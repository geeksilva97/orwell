...
describe('comparison-operators', () => {
  describe('comparison operators', () => {
    it('gt creates a tagged marker with operator "gt"', (t: TestContext) => {
      const result = gt(10);
  ...
  describe('isComparison', () => {
    it('returns true for comparison markers', (t: TestContext) => {
      t.assert.strictEqual(isComparison(gt(1)), true);
      t.assert.strictEqual(isComparison(lte(0)), true);
    });

    it('returns false for non-comparison objects', (t: TestContext) => {
