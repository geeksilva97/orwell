...
function evaluateJavaScriptWatchAction(scriptPath: string, options: { projectId?: string }): void {
  if (!scriptPath) {
...
export default function evaluateJavaScriptWatchCommand(program: Command): void {
